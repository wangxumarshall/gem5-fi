...
|---|---|---|---|---|---|---|
| **Fetch 取指** | IFU 取指宽度 | 4 条/周期 | 未公开 | 超标量（宽度未披露） | 超标量（宽度未披露） | 超标量（宽度未披露） |
...
| | L1i-TLB | 32 项全相联 | 未测 | 48 项全相联 | 48 项全相联 | 32 项全相联 |
| | L1i-cache | 64KB 4-way AIVIVT | 32KB 4-way | 64KB 4-way | 64KB 4-way | 32/64KB（可配）4-way |
