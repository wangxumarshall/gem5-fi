# Campaign `prf_regchain_pilot` — summary

- injector: `physreg`  config: `C0`  mode: `SE`
- cells: 2  reps done: 10  wall: 1079s
- workload: `workloads/directed/reg_chain`  golden_id: `regchain-golden-v1`
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=3 fault_model=transient_bit_flip protection_model=none | 5 | 5 | 100.0% [56.6,100.0] | 0.0% [0.0,43.4] | 100.0% [56.6,100.0] | no |
| phys_mode=arch_frontend target_index=9 fault_model=transient_bit_flip protection_model=none | 5 | 5 | 0.0% [0.0,43.4] | 0.0% [0.0,43.4] | 100.0% [56.6,100.0] | no |
