# Campaign `pwf_v11_fpu_fmaw_rec_pilot` — summary

- injector: `fsu`  config: `C0`  mode: `SE`
- cells: 1  reps done: 100  wall: 100s
...
|---|---|---|---|---|---|---|
| fpu_mode_fma_weighted=True fault_model=transient_bit_flip | 100 | 100 | 99.0% [94.6,99.8] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
