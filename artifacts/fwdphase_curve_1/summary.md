# Campaign `fwdphase_curve_1` — summary
...
|---|---|---|---|---|---|---|
| target_index=0 bit=1 fault_model=delay_omission protection_model=none | 96 | 96 | 0.0% [0.0,3.8] | 100.0% [96.2,100.0] | 100.0% [96.2,100.0] | no |
