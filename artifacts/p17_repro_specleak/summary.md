# Campaign `p17_repro_specleak` — summary

- injector: `rat`  config: `C0`  mode: `SE`
- cells: 1  reps done: 100  wall: 43s
...
|---|---|---|---|---|---|---|
| fault_model=intermittent_burst target_index=10 | 100 | 96 | 15.6% [9.7,24.2] | 0.0% [0.0,3.8] | 96.0% [90.2,98.4] | no |
