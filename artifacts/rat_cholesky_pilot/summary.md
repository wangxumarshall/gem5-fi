# Campaign `rat_cholesky_pilot` — summary

- injector: `rat`  config: `C0`  mode: `SE`
- cells: 2  reps done: 6  wall: 19s
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=3 fault_model=transient_bit_flip protection_model=none | 3 | 3 | 0.0% [0.0,56.1] | 66.7% [20.8,93.9] | 100.0% [43.9,100.0] | no |
| phys_mode=arch_frontend target_index=9 fault_model=transient_bit_flip protection_model=none | 3 | 3 | 0.0% [0.0,56.1] | 0.0% [0.0,56.1] | 100.0% [43.9,100.0] | no |
