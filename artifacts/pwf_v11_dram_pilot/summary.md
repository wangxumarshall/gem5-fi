# Campaign `pwf_v11_dram_pilot` — summary

- injector: `memory`  config: `C0`  mode: `SE`
- cells: 1  reps done: 100  wall: 704s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip mem_addr_start=4194304 mem_addr_end=5242880 | 100 | 100 | 87.0% [79.0,92.2] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
