# Campaign `l1dfwd_formal_reduce` — summary

- injector: `l1d_fwd`  config: `C2`  mode: `SE`
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=0 fault_model=transient_bit_flip protection_model=none | 384 | 384 | 90.9% [87.6,93.4] | 0.0% [0.0,1.0] | 100.0% [99.0,100.0] | no |
