# Campaign `tlbf5_pilot` — summary

- injector: `l1_tlb`  config: `C0-FS`  mode: `FS`
- cells: 1  reps done: 2  wall: 628s
...
|---|---|---|---|---|---|---|
| target_index=0 fault_model=legal_domain_sub protection_model=none | 2 | 2 | 0.0% [0.0,65.8] | 0.0% [0.0,65.8] | 100.0% [34.2,100.0] | yes |
