# Campaign `p81_campaign_smoke` — summary

- injector: `l1d_fwd`  config: `C0`  mode: `SE`
- cells: 1  reps done: 1  wall: 7s
- workload: `/tmp/oracle_smoke_kernel`  golden_id: `oraclesmoke-golden-v1`
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip protection_model=none | 1 | 1 | 100.0% [20.7,100.0] | 0.0% [0.0,79.3] | 100.0% [20.7,100.0] | no |
