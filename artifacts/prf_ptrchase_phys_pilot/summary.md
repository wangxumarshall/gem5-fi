# Campaign `prf_ptrchase_phys_pilot` — summary

- injector: `physreg`  config: `C2`  mode: `SE`
- cells: 1  reps done: 100  wall: 5706s
...
|---|---|---|---|---|---|---|
| phys_mode=phys target_index=0 fault_model=transient_bit_flip protection_model=none | 100 | 100 | 0.0% [0.0,3.7] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
