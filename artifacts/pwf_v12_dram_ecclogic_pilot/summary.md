# Campaign `pwf_v12_dram_ecclogic_pilot` — summary

- injector: `memory`  config: `C0`  mode: `SE`
- cells: 1  reps done: 100  wall: 469s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip mem_addr_start=4194304 mem_addr_end=5242880 protection_model=secded ecc_logic_fault=True | 100 | 100 | 85.0% [76.7,90.7] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
