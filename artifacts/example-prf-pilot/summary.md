# Campaign `example-prf-pilot` — summary

- injector: `physreg`  config: `C0`  mode: `SE`
- cells: 2  reps done: 4  wall: 538s
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=3 fault_model=transient_bit_flip protection_model=none | 2 | 2 | 100.0% [34.2,100.0] | 0.0% [0.0,65.8] | 100.0% [34.2,100.0] | no |
| phys_mode=arch_frontend target_index=9 fault_model=transient_bit_flip protection_model=none | 2 | 2 | 0.0% [0.0,65.8] | 0.0% [0.0,65.8] | 100.0% [34.2,100.0] | no |
