# Campaign `p17_repro_l2` — summary

- injector: `l2`  config: `C0-CACHE`  mode: `SE`
- cells: 1  reps done: 100  wall: 74s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip target_block_addr=4325376 | 100 | 100 | 56.0% [46.2,65.3] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
