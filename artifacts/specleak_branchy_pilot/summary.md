# Campaign `specleak_branchy_pilot` — summary

- injector: `rat`  config: `C2`  mode: `SE`
- cells: 1  reps done: 5  wall: 16s
...
|---|---|---|---|---|---|---|
| target_index=3 fault_model=intermittent_burst protection_model=none | 5 | 5 | 0.0% [0.0,43.4] | 0.0% [0.0,43.4] | 100.0% [56.6,100.0] | no |
