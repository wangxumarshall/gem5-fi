# Campaign `pwf_v11_l2_pilot` — summary

- injector: `l2`  config: `C0-CACHE`  mode: `SE`
- cells: 1  reps done: 100  wall: 93s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip target_block_addr=4325376 | 100 | 100 | 49.0% [39.4,58.7] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
