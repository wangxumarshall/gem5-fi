# Campaign `pwf_v12_bpu_target_pilot` — summary

- injector: `bpu`  config: `C0`  mode: `SE`
- cells: 1  reps done: 100  wall: 35s
- workload: `workloads/directed/branchy_reduce`  golden_id: `branchyreduce-golden-v1`
- base_seed: 20260926  (rep seed = base + cell_ordinal*1000 + rep)

## Per-cell (Wilson 95% CI)

| cell | n | n_valid | P_SDC [CI] | P_DUE [CI] | Reach [CI] | frozen |
|---|---|---|---|---|---|---|
| fault_model=local_mbu | 100 | 100 | 0.0% [0.0,3.7] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
