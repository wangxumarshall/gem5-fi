# Campaign `pwf_v13_dram_ecclogic_formal` — summary

- injector: `memory`  config: `C0`  mode: `SE`
- cells: 1  reps done: 384  wall: 1712s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip mem_addr_start=4194304 mem_addr_end=5242880 protection_model=secded ecc_logic_fault=True | 384 | 384 | 83.3% [79.3,86.7] | 0.0% [0.0,1.0] | 100.0% [99.0,100.0] | no |
