# Campaign `prf_h2_window_pilot` — summary

- injector: `physreg`  config: `C2`  mode: `SE`
- cells: 9  reps done: 270  wall: 184s
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=3 bit=0 rob=96 phys_int=128 fault_model=transient_bit_flip protection_model=none | 30 | 30 | 100.0% [88.6,100.0] | 0.0% [0.0,11.4] | 100.0% [88.6,100.0] | no |
| phys_mode=arch_frontend target_index=3 bit=0 rob=96 phys_int=160 fault_model=transient_bit_flip protection_model=none | 30 | 30 | 100.0% [88.6,100.0] | 0.0% [0.0,11.4] | 100.0% [88.6,100.0] | no |
| phys_mode=arch_frontend target_index=3 bit=0 rob=96 phys_int=192 fault_model=transient_bit_flip protection_model=none | 30 | 30 | 100.0% [88.6,100.0] | 0.0% [0.0,11.4] | 100.0% [88.6,100.0] | no |
| phys_mode=arch_frontend target_index=3 bit=0 rob=128 phys_int=128 fault_model=transient_bit_flip protection_model=none | 30 | 30 | 100.0% [88.6,100.0] | 0.0% [0.0,11.4] | 100.0% [88.6,100.0] | no |
| phys_mode=arch_frontend target_index=3 bit=0 rob=128 phys_int=160 fault_model=transient_bit_flip protection_model=none | 30 | 30 | 100.0% [88.6,100.0] | 0.0% [0.0,11.4] | 100.0% [88.6,100.0] | no |
| phys_mode=arch_frontend target_index=3 bit=0 rob=128 phys_int=192 fault_model=transient_bit_flip protection_model=none | 30 | 30 | 100.0% [88.6,100.0] | 0.0% [0.0,11.4] | 100.0% [88.6,100.0] | no |
