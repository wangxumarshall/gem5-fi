# Campaign `lsqfwd_formal_fwd` — summary

- injector: `lsq_fwd`  config: `C2`  mode: `SE`
- cells: 1  reps done: 384  wall: 278s
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=0 fault_model=transient_bit_flip protection_model=none | 384 | 381 | 4.7% [3.0,7.3] | 27.6% [23.3,32.3] | 100.0% [99.0,100.0] | no |
