# Campaign `pilot_physreg_x3` — summary

- injector: `physreg`  config: `C0`  mode: `SE`
- cells: 1  reps done: 3  wall: 360s
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=3 fault_model=transient_bit_flip protection_model=none | 3 | 3 | 100.0% [43.9,100.0] | 0.0% [0.0,56.1] | 100.0% [43.9,100.0] | no |
