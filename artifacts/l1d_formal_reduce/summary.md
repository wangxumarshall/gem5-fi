# Campaign `l1d_formal_reduce` — summary

- injector: `cache`  config: `C0-CACHE`  mode: `SE`
- cells: 1  reps done: 384  wall: 2390s
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=0 fault_model=transient_bit_flip protection_model=none | 384 | 384 | 97.7% [95.6,98.8] | 0.0% [0.0,1.0] | 100.0% [99.0,100.0] | no |
