# Campaign `pwf_v12_l2_victim_pilot` — summary

- injector: `l2`  config: `C0-CACHE`  mode: `SE`
- cells: 1  reps done: 100  wall: 67s
- workload: `workloads/directed/stencil_5pt_kernel`  golden_id: `stencil5pt-golden-v1`
- base_seed: 20260920  (rep seed = base + cell_ordinal*1000 + rep)

## Per-cell (Wilson 95% CI)

| cell | n | n_valid | P_SDC [CI] | P_DUE [CI] | Reach [CI] | frozen |
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip victim_fault=True l2_size=256KiB | 100 | 100 | 53.0% [43.3,62.5] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
