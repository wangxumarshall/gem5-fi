# Campaign `fwdphase_curve_4` — summary

- injector: `lsqfwd`  config: `C2`  mode: `SE`
- cells: 1  reps done: 96  wall: 108s
...
|---|---|---|---|---|---|---|
| target_index=0 bit=4 fault_model=delay_omission protection_model=none | 96 | 96 | 0.0% [0.0,3.8] | 100.0% [96.2,100.0] | 100.0% [96.2,100.0] | no |
