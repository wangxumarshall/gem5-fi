# Campaign `pwf_v12_iq_omit_pilot` — summary

- injector: `iq`  config: `C0`  mode: `SE`
- cells: 1  reps done: 100  wall: 865s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip | 100 | 100 | 0.0% [0.0,3.7] | 58.0% [48.2,67.2] | 100.0% [96.3,100.0] | no |
