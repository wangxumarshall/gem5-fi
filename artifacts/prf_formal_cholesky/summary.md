# Campaign `prf_formal_cholesky` — summary

- injector: `physreg`  config: `C2`  mode: `SE`
- cells: 2  reps done: 768  wall: 2666s
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=3 fault_model=transient_bit_flip protection_model=none | 384 | 384 | 3.9% [2.4,6.3] | 92.7% [89.7,94.9] | 100.0% [99.0,100.0] | no |
