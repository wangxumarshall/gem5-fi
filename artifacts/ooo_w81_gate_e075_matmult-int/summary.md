# Campaign `ooo_w81_gate_e075_matmult-int` — summary

- injector: `rob`  config: `C3`  mode: `SE`
- cells: 1  reps done: 354  wall: 2253s
...
- two_phase (W3.1): tiers=['F0'] pilot_n=20 pick_top=1 formal runs/selected tier=334; full selection: artifacts/ooo_w81_gate_e075_matmult-int/tier_selection.json
