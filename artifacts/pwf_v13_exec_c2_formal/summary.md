# Campaign `pwf_v13_exec_c2_formal` — summary

- injector: `exec`  config: `C2`  mode: `SE`
- cells: 1  reps done: 384  wall: 204s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip | 384 | 384 | 0.0% [0.0,1.0] | 52.1% [47.1,57.0] | 100.0% [99.0,100.0] | no |
