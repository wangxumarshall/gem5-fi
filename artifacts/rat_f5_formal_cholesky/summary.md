# Campaign `rat_f5_formal_cholesky` — summary

- injector: `rat`  config: `C2`  mode: `SE`
- cells: 2  reps done: 768  wall: 1256s
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=3 fault_model=legal_domain_sub protection_model=none | 384 | 377 | 0.0% [0.0,1.0] | 59.7% [54.7,64.5] | 100.0% [99.0,100.0] | no |
| phys_mode=arch_frontend target_index=9 fault_model=legal_domain_sub protection_model=none | 384 | 384 | 0.0% [0.0,1.0] | 0.5% [0.1,1.9] | 100.0% [99.0,100.0] | no |
