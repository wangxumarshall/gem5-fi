# Campaign `p82_uniform_smoke` — summary

- injector: `fsu`  config: `C0`  mode: `SE`
- cells: 1  reps done: 5  wall: 8s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip protection_model=none | 5 | 5 | 0.0% [0.0,43.4] | 0.0% [0.0,43.4] | 100.0% [56.6,100.0] | no |
