# Campaign `exmon_spinlock_pilot` — summary

- injector: `exmon`  config: `C0`  mode: `SE`
- cells: 1  reps done: 5  wall: 18s
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=0 fault_model=transient_bit_flip protection_model=none | 5 | 5 | 0.0% [0.0,43.4] | 100.0% [56.6,100.0] | 100.0% [56.6,100.0] | no |
