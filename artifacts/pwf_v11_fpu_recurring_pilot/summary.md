# Campaign `pwf_v11_fpu_recurring_pilot` — summary

- injector: `fsu`  config: `C0`  mode: `SE`
- cells: 1  reps done: 100  wall: 107s
...
|---|---|---|---|---|---|---|
| fpu_mode_recurring_stuck=True fault_model=recurring_result_stuck | 100 | 100 | 100.0% [96.3,100.0] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
