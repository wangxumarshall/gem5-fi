# Campaign `fwdsrc_formal_fwd` — summary

- injector: `lsqfwd`  config: `C2`  mode: `SE`
- cells: 1  reps done: 384  wall: 274s
...
|---|---|---|---|---|---|---|
| target_index=0 fault_model=stuck_at_zero protection_model=none | 384 | 378 | 37.6% [32.8,42.6] | 57.4% [52.4,62.3] | 100.0% [99.0,100.0] | no |
