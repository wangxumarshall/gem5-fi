# Campaign `pwf_v13_dram_c2_formal` — summary

- injector: `memory`  config: `C2`  mode: `SE`
- cells: 1  reps done: 384  wall: 1811s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip mem_addr_start=4194304 mem_addr_end=5242880 | 384 | 384 | 30.2% [25.8,35.0] | 0.0% [0.0,1.0] | 100.0% [99.0,100.0] | no |
