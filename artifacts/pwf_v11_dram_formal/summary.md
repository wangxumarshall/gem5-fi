# Campaign `pwf_v11_dram_formal` — summary

- injector: `memory`  config: `C0`  mode: `SE`
- cells: 1  reps done: 384  wall: 1683s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip mem_addr_start=4194304 mem_addr_end=5242880 | 384 | 384 | 85.4% [81.5,88.6] | 0.0% [0.0,1.0] | 100.0% [99.0,100.0] | no |
