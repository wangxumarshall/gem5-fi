# Campaign `sysreg_f5_pilot` — summary

- injector: `sysreg`  config: `C0-FS`  mode: `FS`
- cells: 2  reps done: 10  wall: 1271s
...
|---|---|---|---|---|---|---|
| target_index=0 fault_model=legal_domain_sub protection_model=none | 5 | 5 | 0.0% [0.0,43.4] | 0.0% [0.0,43.4] | 100.0% [56.6,100.0] | yes |
| target_index=0 fault_model=transient_bit_flip protection_model=none | 5 | 5 | 0.0% [0.0,43.4] | 0.0% [0.0,43.4] | 100.0% [56.6,100.0] | yes |
