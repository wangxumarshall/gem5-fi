# Campaign `pwf_v11_fpu_pilot` — summary

- injector: `fsu`  config: `C0`  mode: `SE`
- cells: 1  reps done: 100  wall: 101s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip protection_model=none | 100 | 100 | 100.0% [96.3,100.0] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
