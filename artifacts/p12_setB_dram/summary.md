# Campaign `p12_setB_dram` — summary

- injector: `memory`  config: `C0`  mode: `SE`
- cells: 1  reps done: 20  wall: 130s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip mem_addr_start=4194304 mem_addr_end=5242880 | 20 | 20 | 85.0% [64.0,94.8] | 0.0% [0.0,16.1] | 100.0% [83.9,100.0] | no |
