# Campaign `iq_f5f6_pilot` — summary

- injector: `iq`  config: `C2`  mode: `SE`
- cells: 2  reps done: 10  wall: 9s
...
|---|---|---|---|---|---|---|
| target_index=0 fault_model=legal_domain_sub protection_model=none | 5 | 5 | 0.0% [0.0,43.4] | 100.0% [56.6,100.0] | 100.0% [56.6,100.0] | no |
| target_index=0 fault_model=intermittent_burst protection_model=none | 5 | 5 | 0.0% [0.0,43.4] | 100.0% [56.6,100.0] | 100.0% [56.6,100.0] | no |
