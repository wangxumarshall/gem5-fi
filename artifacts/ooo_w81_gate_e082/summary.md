# Campaign `ooo_w81_gate_e082` — summary

- injector: `rob`  config: `C3`  mode: `SE`
- cells: 1  reps done: 2020  wall: 37830s
...
- two_phase (W3.1): tiers=['F0'] pilot_n=20 pick_top=1 formal runs/selected tier=2000; full selection: artifacts/ooo_w81_gate_e082/tier_selection.json
...
|---|---|---|---|---|---|---|
| target_index=-1 field=destid sub_field=destid_bitflip fault_model=transient_bit_flip protection_model=none | 2000 | 2000 | 0.0% [0.0,0.2] | 100.0% [99.8,100.0] | 100.0% [99.8,100.0] | no |
