# Campaign `pwf_v12_dram_ecc_pilot` — summary

- injector: `memory`  config: `C0`  mode: `SE`
- cells: 2  reps done: 200  wall: 901s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip mem_addr_start=4194304 mem_addr_end=5242880 protection_model=none | 100 | 100 | 87.0% [79.0,92.2] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
| fault_model=transient_bit_flip mem_addr_start=4194304 mem_addr_end=5242880 protection_model=secded | 100 | 100 | 0.0% [0.0,3.7] | 0.0% [0.0,3.7] | 100.0% [96.3,100.0] | no |
