# Campaign `fpu_formal_neon` — summary

- injector: `fsu`  config: `C2`  mode: `SE`
- cells: 1  reps done: 384  wall: 3500s
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=0 fault_model=transient_bit_flip protection_model=none | 384 | 67 | 0.0% [0.0,5.4] | 0.0% [0.0,5.4] | 17.4% [14.0,21.6] | no |
