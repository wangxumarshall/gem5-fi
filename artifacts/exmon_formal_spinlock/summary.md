# Campaign `exmon_formal_spinlock` — summary

- injector: `exmon`  config: `C2`  mode: `SE`
- cells: 1  reps done: 384  wall: 1481s
- workload: `workloads/directed/spinlock_checksum`  golden_id: `spinlockchecksum-golden-v1`
...
|---|---|---|---|---|---|---|
| phys_mode=arch_frontend target_index=0 fault_model=transient_bit_flip protection_model=none | 384 | 384 | 0.0% [0.0,1.0] | 100.0% [99.0,100.0] | 100.0% [99.0,100.0] | no |
