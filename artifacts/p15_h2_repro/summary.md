# Campaign `p15_h2_repro` — summary

- injector: `physreg`  config: `C2`  mode: `SE`
- cells: 2  reps done: 20  wall: 9s
...
|---|---|---|---|---|---|---|
| fault_model=transient_bit_flip bit=0 target_index=3 rob=128 | 10 | 10 | 100.0% [72.2,100.0] | 0.0% [0.0,27.8] | 100.0% [72.2,100.0] | no |
