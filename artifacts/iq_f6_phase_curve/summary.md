# Campaign `iq_f6_phase_curve` — summary

- injector: `iq`  config: `C2`  mode: `SE`
- cells: 4  reps done: 384  wall: 63s
...
|---|---|---|---|---|---|---|
| target_index=0 bit=1 fault_model=intermittent_burst protection_model=none | 96 | 96 | 0.0% [0.0,3.8] | 100.0% [96.2,100.0] | 100.0% [96.2,100.0] | no |
| target_index=0 bit=2 fault_model=intermittent_burst protection_model=none | 96 | 96 | 0.0% [0.0,3.8] | 100.0% [96.2,100.0] | 100.0% [96.2,100.0] | no |
| target_index=0 bit=4 fault_model=intermittent_burst protection_model=none | 96 | 96 | 0.0% [0.0,3.8] | 100.0% [96.2,100.0] | 100.0% [96.2,100.0] | no |
| target_index=0 bit=8 fault_model=intermittent_burst protection_model=none | 96 | 96 | 0.0% [0.0,3.8] | 100.0% [96.2,100.0] | 100.0% [96.2,100.0] | no |
